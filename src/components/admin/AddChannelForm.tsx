...
export const AddChannelForm: React.FC<AddChannelFormProps> = ({
  ...
  const [checkInterval, setCheckInterval] = useState(3600); // 1 hour
  ...
  const addChannelMutation = api.forecasters.addChannel.useMutation({
    onSuccess: () => {
      ...
      >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure how often to check for new content
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Check Interval: {formatCheckInterval(checkInterval)}
                  </label>
                  <input
                    type="range"
                    min="300" // 5 minutes
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Enable automatic content collection</p>
                  </div>
                  <input
                    type="checkbox"
                    checked={isActive}
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-gray-500">
                    Checks every {formatCheckInterval(checkInterval)}
                  </div>
        ...
        <div className="flex items-center justify-end gap-2 p-6 border-t bg-gray-50">
          ...
          <Button
            ...
            disabled={addChannelMutation.isPending || !parsedChannel}
