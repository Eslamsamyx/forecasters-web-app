...
const SignIn: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Sign In - Prediction Prism Analytics</title>
        <meta name="description" content="Sign in to your Prediction Prism Analytics account" />
      </Head>
      <motion.div
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 text-white">
            ...
            >
              <h2 className="text-4xl font-bold mb-6 text-white">
                Predict Market Movements with AI
              </h2>
              <p className="text-xl text-white/90 mb-12">
                Join thousands of traders using our advanced analytics platform
              </p>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <p className="text-slate-300">Track predictions and performance metrics in real-time</p>
                </motion.div>
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-white">Verified Forecasters</h3>
                  <p className="text-slate-300">Follow top-performing experts with proven track records</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-slate-300">Advanced algorithms analyze market patterns 24/7</p>
                </motion.div>
              </div>
              ...
              >
                <div>
                  ...
                  <div className="text-slate-400">Active Forecasters</div>
                </div>
                <div>
